  ...
  <div class="heading">
    ...
    <div class="btns">
      <a class="btn btn-lg btn-primary" href="download.php" role="button">
        <span>&#9889;</span> Free download <b>â€º</b>
      </a>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-4 on-hover">
        <div class="card border-0 mb-4">
          ...
          <h5 class="font-weight-medium mt-3">
            <a href="#" class="text-decoration-none link">You should have eagleâ€™s eye on new trends and techonogies</a>
          </h5>
      ...
      <div class="col-md-4 on-hover">
        <div class="card border-0 mb-4">
          ...
          <h5 class="font-weight-medium mt-3">
            <a href="#" class="text-decoration-none link">New Seminar on Newest Food Recipe from Worldâ€™s Best</a>
          </h5>
          <p class="mt-3">Business Park, Opp. Corns Sam Restaurant, New Yoark, US</p>
          <a href="#" class="text-decoration-none linking text-themecolor mt-2">Learn More</a>
        </div>
    ...
    <div class="nav float-start">
      <ul class="list-inline">
        ...
        <li class="list-inline-item">
          ...
          <span class="d-none d-md-inline">contact@mysite.com</span>
        </li>
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <div data-v-currency>
                  <button class="dropdown-item" value="EUR" name="currency" data-v-currency-code>
                    <span data-v-currency-symbol_left>â‚¬</span>
                    <span data-v-currency-symbol_right>â‚¬</span>
...
<nav class="navigation-1 clearfix">
  ...
  <div class="navbar navbar-expand-md navbar-dark">
	...
	Vvveb.SectionsGroup["Navigation"] = ["navigation/navigation-1","navigation/navigation-2","navigation/navigation-3"];
